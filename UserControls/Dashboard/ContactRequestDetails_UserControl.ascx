<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ContactRequestDetails_UserControl.ascx.cs" Inherits="CrifAustria.UserControls.Dashboard.ContactRequestDetails_UserControl" %>
<div class="block">
        <style type="text/css">
            ...
            <td valign="top" width="52%">
                <asp:UpdatePanel runat="server" ID="updatePanel1">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDetails" runat="server" SelectCommand="SELECT [Id],[firstName],[lastName],[email],[telephone],[company],[jobTitle],[industry],[bestWayToReach],
                            [message],[CreatedDate]  FROM [dbo].[contactUs]  WHERE ([Id] = @Id)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="GridView1" Name="id" PropertyName="SelectedValue" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSourceMain" runat="server"
                        SelectCommand="SELECT [Id],[firstName],[lastName],[email],[telephone],[company],[jobTitle],[industry],[bestWayToReach],
                            [message],[CreatedDate]  FROM [dbo].[contactUs] ORDER BY [CreatedDate] DESC"
                        DeleteCommand="DELETE FROM [dbo].[contactUs] WHERE [Id]=@Id"></asp:SqlDataSource>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
