<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SheduleConsultationRequestDetails_UserControl.ascx.cs" Inherits="CrifAustria.UserControls.Dashboard.SheduleConsultationRequestDetails_UserControl" %>
<div class="block">
        <style type="text/css">
            ...
            <td valign="top" width="52%">
                <asp:UpdatePanel runat="server" ID="updatePanel1">
                    <ContentTemplate>
                            ...
                            <Fields>
                                <asp:TemplateField ShowHeader="false">
                                    <ItemTemplate>
                                        ...
                                        <%#Eval("bestWayToReach")%>
                                        <br /> 
                                         <strong>How Did You hear About:</strong> 
                                        <%#Eval("howDidYouhearAbout")%>
                                        <br /> 
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDetails" runat="server" SelectCommand="SELECT [Id],[firstName],[lastName],[email],[telephone],[company],[jobTitle],[industry],[bestWayToReach],[howDidYouHearAbout],
                            [message],[CreatedDate]  FROM [dbo].[sheduleConsultation]  WHERE ([Id] = @Id)">
                        <SelectParameters>
                            <asp:ControlParameter ControlID="GridView1" Name="id" PropertyName="SelectedValue" Type="Int32" />
                        </SelectParameters>
                    </asp:SqlDataSource>
                    <asp:SqlDataSource ID="SqlDataSourceMain" runat="server"
                        SelectCommand="SELECT [Id],[firstName],[lastName],[email],[telephone],[company],[jobTitle],[industry],[bestWayToReach],[howDidYouHearAbout],
                            [message],[CreatedDate]  FROM [dbo].[sheduleConsultation] ORDER BY [CreatedDate] DESC"
                        DeleteCommand="DELETE FROM [dbo].[sheduleConsultation] WHERE [Id]=@Id"></asp:SqlDataSource>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
