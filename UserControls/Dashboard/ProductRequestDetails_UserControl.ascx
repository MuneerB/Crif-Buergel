<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ProductRequestDetails_UserControl.ascx.cs" Inherits="CrifAustria.UserControls.Dashboard.ProductRequestDetails_UserControl" %>
<div class="block">
        <style type="text/css">
                ...
                <asp:UpdatePanel runat="server" ID="updatePanel1">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="SqlDataSourceDetails" runat="server" SelectCommand="SELECT [Id],[First_Name],[Last_Name],[Email],[Telephone],[Company],[JobTitle],[Industry],[ProductName],
                            [CreatedDate] FROM [dbo].[ProductRequests] WHERE ([Id] = @Id)">
                        <SelectParameters>
                    ...
                    <asp:SqlDataSource ID="SqlDataSourceMain" runat="server"
                        SelectCommand="SELECT [Id],[First_Name],[Last_Name],[Email],[Telephone],[Company],[JobTitle],[Industry],[ProductName],
                            [CreatedDate]  FROM [dbo].[ProductRequests] ORDER BY [CreatedDate] DESC"
                        DeleteCommand="DELETE FROM [dbo].[ProductRequests] WHERE [Id]=@Id"></asp:SqlDataSource>
                </ContentTemplate>
            </asp:UpdatePanel>
        </td>
    </tr>
