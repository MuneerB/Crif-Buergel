...
{
    public partial class NewsletterRequestDetails_UserControl : System.Web.UI.UserControl
    {
        ...
        protected void ibDownload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            sqlConnection.Open();
            sqlSelectQuery = String.Format("SELECT [Id],[firstName],[lastName],[email],[telephone],[company],[jobTitle],[industry],[bestWayToReach]," +
                            "[message],[CreatedDate]  FROM [dbo].[newsletterSubscription]  ORDER BY [CreatedDate] DESC", sqlConnection);
