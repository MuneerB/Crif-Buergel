...
{
    public partial class SuccessStoriesRequestDetails_UserControl : System.Web.UI.UserControl
    {
        ...
        protected void ibDownload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            sqlConnection.Open();
            sqlSelectQuery = String.Format("SELECT [Id],[First_Name],[Last_Name],[Email],[Telephone],[Company],[JobTitle],[Industry],[ProductName]," +
                            "[CreatedDate] FROM [dbo].[SuccessStoryRequests] ORDER BY [CreatedDate] DESC", sqlConnection);
