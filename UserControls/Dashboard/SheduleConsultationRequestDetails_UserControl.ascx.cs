...
namespace CrifAustria.UserControls.Dashboard
{
    public partial class SheduleConsultationRequestDetails_UserControl : System.Web.UI.UserControl
    {
        ...
        protected void ibDownload_Click(object sender, ImageClickEventArgs e)
        {
            ...
            sqlConnection.Open();
            sqlSelectQuery = String.Format("SELECT [Id],[firstName],[lastName],[email],[telephone],[company],[jobTitle],[industry],[bestWayToReach],[howDidYouHearAbout]," +
                            "[message],[CreatedDate]  FROM [dbo].[sheduleConsultation]  ORDER BY [CreatedDate] DESC", sqlConnection);
