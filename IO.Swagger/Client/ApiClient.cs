...
namespace IO.Swagger.Client
{
    ...
    public class ApiClient
    {
        ...
        /// with default configuration and base path (https://api.newsletter2go.com).
        /// </summary>
        public ApiClient()
        {
            Configuration = Configuration.Default;
            RestClient = new RestClient("https://api.newsletter2go.com");
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="ApiClient" /> class
        /// with default base path (https://api.newsletter2go.com).
        /// </summary>
        ...
        public ApiClient(String basePath = "https://api.newsletter2go.com")
        {
