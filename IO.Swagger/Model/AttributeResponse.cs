...
{
    /// <summary>
    /// The response for getting the attributes
    /// </summary>
    [DataContract]
    public partial class AttributeResponse :  IEquatable<AttributeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeResponse" /> class.
        /// </summary>
        /// <param name="Info">Info.</param>
        /// <param name="Value">Value.</param>
        public AttributeResponse(Info Info = null, List<AttributeGet> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<AttributeGet> Value { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttributeResponse);
        }

        /// <summary>
        /// Returns true if AttributeResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of AttributeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
