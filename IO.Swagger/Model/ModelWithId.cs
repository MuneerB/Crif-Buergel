...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ModelWithId :  IEquatable<ModelWithId>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ModelWithId" /> class.
        /// </summary>
        /// <param name="Id">Id.</param>
        public ModelWithId(string Id = null)
        {
            this.Id = Id;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ModelWithId);
        }

        /// <summary>
        /// Returns true if ModelWithId instances are equal
        /// </summary>
        /// <param name="other">Instance of ModelWithId to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModelWithId other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
