...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupGet :  IEquatable<GroupGet>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="GroupGet" /> class.
        /// </summary>
        /// <param name="Id">the id of the Group.</param>
        /// <param name="Name">the name of the group.</param>
        /// <param name="Description">the description of the group.</param>
        /// <param name="ListId">the list id the group belongs to. Default_List of company is used if no list_id is submitted.</param>
        public GroupGet(string Id = null, string Name = null, string Description = null, string ListId = null)
        {
            this.Id = Id;
            this.Name = Name;
        ...
        /// <summary>
        /// the list id the group belongs to. Default_List of company is used if no list_id is submitted
        /// </summary>
        /// <value>the list id the group belongs to. Default_List of company is used if no list_id is submitted</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupGet);
        }

        /// <summary>
        /// Returns true if GroupGet instances are equal
        /// </summary>
        /// <param name="other">Instance of GroupGet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupGet other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
