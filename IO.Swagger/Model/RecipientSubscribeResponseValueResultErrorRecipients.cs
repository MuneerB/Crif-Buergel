...
{
    /// <summary>
    /// RecipientSubscribeResponseValueResultErrorRecipients
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribeResponseValueResultErrorRecipients :  IEquatable<RecipientSubscribeResponseValueResultErrorRecipients>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribeResponseValueResultErrorRecipients" /> class.
        /// </summary>
        /// <param name="Duplicate">Duplicate.</param>
        /// <param name="Invalid">Invalid.</param>
        public RecipientSubscribeResponseValueResultErrorRecipients(List<RecipientSimple> Duplicate = null, List<RecipientSimple> Invalid = null)
        {
        ...
        public List<RecipientSimple> Duplicate { get; set; }
        /// <summary>
        /// Gets or Sets Invalid
        /// </summary>
        [DataMember(Name="invalid", EmitDefaultValue=false)]
        public List<RecipientSimple> Invalid { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribeResponseValueResultErrorRecipients {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribeResponseValueResultErrorRecipients);
        }

        /// <summary>
        /// Returns true if RecipientSubscribeResponseValueResultErrorRecipients instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribeResponseValueResultErrorRecipients to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribeResponseValueResultErrorRecipients other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Duplicate != null &&
                    this.Duplicate.SequenceEqual(other.Duplicate)
                ) && 
                (
                    this.Invalid == other.Invalid ||
                    this.Invalid != null &&
                    this.Invalid.SequenceEqual(other.Invalid)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Duplicate != null)
                    hash = hash * 59 + this.Duplicate.GetHashCode();
