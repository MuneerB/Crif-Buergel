...
{
    /// <summary>
    /// The response when a resource was successfully deleted
    /// </summary>
    [DataContract]
    public partial class ApiResponseDelete :  IEquatable<ApiResponseDelete>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponseDelete" /> class.
        /// </summary>
        public ApiResponseDelete()
        {
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponseDelete {\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ApiResponseDelete);
        }

        /// <summary>
        /// Returns true if ApiResponseDelete instances are equal
        /// </summary>
        /// <param name="other">Instance of ApiResponseDelete to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponseDelete other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
