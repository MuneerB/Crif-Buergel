...
{
    /// <summary>
    /// RecipientSubscribeResponseValueResult
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribeResponseValueResult :  IEquatable<RecipientSubscribeResponseValueResult>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribeResponseValueResult" /> class.
        /// </summary>
        /// <param name="Success">Success.</param>
        /// <param name="Error">Error.</param>
        public RecipientSubscribeResponseValueResult(RecipientSubscribeResponseValueResultSuccess Success = null, RecipientSubscribeResponseValueResultError Error = null)
        {
        ...
        public RecipientSubscribeResponseValueResultSuccess Success { get; set; }
        /// <summary>
        /// Gets or Sets Error
        /// </summary>
        [DataMember(Name="error", EmitDefaultValue=false)]
        public RecipientSubscribeResponseValueResultError Error { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribeResponseValueResult {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribeResponseValueResult);
        }

        /// <summary>
        /// Returns true if RecipientSubscribeResponseValueResult instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribeResponseValueResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribeResponseValueResult other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
