...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class NewsletterSend :  IEquatable<NewsletterSend>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsletterSend" /> class.
        /// </summary>
        /// <param name="Scheduled">ISO8601 timestamp for defining when the newsletter shall be send. If not set, the newsletter will be send immediatly.</param>
        /// <param name="GroupIds">a list of group ids to which the newsletter gets send (If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list).</param>
        /// <param name="RecipientIds">a list of recipient_ids ids to which the newsletter gets send (If group_ids is given, recipient_ids are ignored. If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list).</param>
        /// <param name="Contexts">A list of contexts in which every context must have at least an email-address under recipient &lt;code&gt;{\&quot;recipient\&quot;:{\&quot;email\&quot;:\&quot;...\&quot;}}&lt;/code&gt;.&lt;br&gt;Contexts are only allowed for mailings of type transaction.</param>
        public NewsletterSend(string Scheduled = null, List<string> GroupIds = null, List<string> RecipientIds = null, List<Object> Contexts = null)
        {
        ...
        /// <summary>
        /// ISO8601 timestamp for defining when the newsletter shall be send. If not set, the newsletter will be send immediatly
        /// </summary>
        /// <value>ISO8601 timestamp for defining when the newsletter shall be send. If not set, the newsletter will be send immediatly</value>
        [DataMember(Name="scheduled", EmitDefaultValue=false)]
        public string Scheduled { get; set; }
        /// <summary>
        /// a list of group ids to which the newsletter gets send (If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list)
        /// </summary>
        /// <value>a list of group ids to which the newsletter gets send (If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list)</value>
        [DataMember(Name="group_ids", EmitDefaultValue=false)]
        public List<string> GroupIds { get; set; }
        /// <summary>
        /// a list of recipient_ids ids to which the newsletter gets send (If group_ids is given, recipient_ids are ignored. If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list)
        /// </summary>
        /// <value>a list of recipient_ids ids to which the newsletter gets send (If group_ids is given, recipient_ids are ignored. If neither group_ids nor recipient_ids are given, the newsletter gets send to the whole list)</value>
        [DataMember(Name="recipient_ids", EmitDefaultValue=false)]
        public List<string> RecipientIds { get; set; }
        /// <summary>
        /// A list of contexts in which every context must have at least an email-address under recipient &lt;code&gt;{\&quot;recipient\&quot;:{\&quot;email\&quot;:\&quot;...\&quot;}}&lt;/code&gt;.&lt;br&gt;Contexts are only allowed for mailings of type transaction
        /// </summary>
        /// <value>A list of contexts in which every context must have at least an email-address under recipient &lt;code&gt;{\&quot;recipient\&quot;:{\&quot;email\&quot;:\&quot;...\&quot;}}&lt;/code&gt;.&lt;br&gt;Contexts are only allowed for mailings of type transaction</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class NewsletterSend {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NewsletterSend);
        }

        /// <summary>
        /// Returns true if NewsletterSend instances are equal
        /// </summary>
        /// <param name="other">Instance of NewsletterSend to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsletterSend other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
