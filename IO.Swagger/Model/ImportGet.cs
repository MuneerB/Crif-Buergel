...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ImportGet :  IEquatable<ImportGet>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ImportGet" /> class.
        /// </summary>
        /// <param name="CountInserted">the number of inserted recipients.</param>
        /// <param name="CountUpdated">the number of updated recipients.</param>
        /// <param name="CountFailed">the number of failed recipients.</param>
        /// <param name="DuplicateRecipients">the recipients duplicated in the file.</param>
        /// <param name="InvalidRecipients">the recipients invalid in the file (like recipients with an invalid email-address.</param>
        public ImportGet(int? CountInserted = null, int? CountUpdated = null, int? CountFailed = null, List<RecipientSimple> DuplicateRecipients = null, List<RecipientSimple> InvalidRecipients = null)
        {
            this.CountInserted = CountInserted;
            this.CountUpdated = CountUpdated;
            this.CountFailed = CountFailed;
            this.DuplicateRecipients = DuplicateRecipients;
            this.InvalidRecipients = InvalidRecipients;
        }
        
        /// <summary>
        /// the number of inserted recipients
        /// </summary>
        /// <value>the number of inserted recipients</value>
        [DataMember(Name="count_inserted", EmitDefaultValue=false)]
        public int? CountInserted { get; set; }
        /// <summary>
        /// the number of updated recipients
        /// </summary>
        /// <value>the number of updated recipients</value>
        [DataMember(Name="count_updated", EmitDefaultValue=false)]
        public int? CountUpdated { get; set; }
        /// <summary>
        /// the number of failed recipients
        /// </summary>
        /// <value>the number of failed recipients</value>
        [DataMember(Name="count_failed", EmitDefaultValue=false)]
        public int? CountFailed { get; set; }
        /// <summary>
        /// the recipients duplicated in the file
        /// </summary>
        /// <value>the recipients duplicated in the file</value>
        [DataMember(Name="duplicate_recipients", EmitDefaultValue=false)]
        public List<RecipientSimple> DuplicateRecipients { get; set; }
        /// <summary>
        /// the recipients invalid in the file (like recipients with an invalid email-address
        /// </summary>
        /// <value>the recipients invalid in the file (like recipients with an invalid email-address</value>
        [DataMember(Name="invalid_recipients", EmitDefaultValue=false)]
        public List<RecipientSimple> InvalidRecipients { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ImportGet {\n");
            sb.Append("  CountInserted: ").Append(CountInserted).Append("\n");
            sb.Append("  CountUpdated: ").Append(CountUpdated).Append("\n");
            sb.Append("  CountFailed: ").Append(CountFailed).Append("\n");
            sb.Append("  DuplicateRecipients: ").Append(DuplicateRecipients).Append("\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ImportGet);
        }

        /// <summary>
        /// Returns true if ImportGet instances are equal
        /// </summary>
        /// <param name="other">Instance of ImportGet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ImportGet other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    this.CountInserted == other.CountInserted ||
                    this.CountInserted != null &&
                    this.CountInserted.Equals(other.CountInserted)
                ) && 
                (
                    this.CountUpdated == other.CountUpdated ||
                    this.CountUpdated != null &&
                    this.CountUpdated.Equals(other.CountUpdated)
                ) && 
                (
                    this.CountFailed == other.CountFailed ||
                    this.CountFailed != null &&
                    this.CountFailed.Equals(other.CountFailed)
                ) && 
                (
                    this.DuplicateRecipients == other.DuplicateRecipients ||
                    this.DuplicateRecipients != null &&
                    this.DuplicateRecipients.SequenceEqual(other.DuplicateRecipients)
                ) && 
                (
                    this.InvalidRecipients == other.InvalidRecipients ||
                    this.InvalidRecipients != null &&
                    this.InvalidRecipients.SequenceEqual(other.InvalidRecipients)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.CountInserted != null)
                    hash = hash * 59 + this.CountInserted.GetHashCode();
                if (this.CountUpdated != null)
                    hash = hash * 59 + this.CountUpdated.GetHashCode();
                if (this.CountFailed != null)
                    hash = hash * 59 + this.CountFailed.GetHashCode();
                if (this.DuplicateRecipients != null)
                    hash = hash * 59 + this.DuplicateRecipients.GetHashCode();
                if (this.InvalidRecipients != null)
                    hash = hash * 59 + this.InvalidRecipients.GetHashCode();
                return hash;
            }
        }
    }
