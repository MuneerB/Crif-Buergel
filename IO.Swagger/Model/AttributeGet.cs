...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttributeGet :  IEquatable<AttributeGet>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributeGet" /> class.
        /// </summary>
        ...
        public AttributeGet(string Id = null, string Name = null, string Type = null, string SubType = null)
        {
            this.Id = Id;
            this.Name = Name;
            this.Type = Type;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttributeGet);
        }

        /// <summary>
        /// Returns true if AttributeGet instances are equal
        /// </summary>
        /// <param name="other">Instance of AttributeGet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributeGet other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
