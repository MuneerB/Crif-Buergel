...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class UserPatch :  IEquatable<UserPatch>
    {
        /// <summary>
        ...
        /// <param name="FirstName">the first_name of the user.</param>
        /// <param name="LastName">the last_name of the user.</param>
        /// <param name="Gender">the gender of the user.</param>
        public UserPatch(string Email = null, string FirstName = null, string LastName = null, GenderEnum? Gender = null)
        {
            this.Email = Email;
        ...
        /// </summary>
        /// <value>the first_name of the user</value>
        [DataMember(Name="first_name", EmitDefaultValue=false)]
        public string FirstName { get; set; }
        /// <summary>
        /// the last_name of the user
        /// </summary>
        /// <value>the last_name of the user</value>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as UserPatch);
        }

        /// <summary>
        /// Returns true if UserPatch instances are equal
        /// </summary>
        /// <param name="other">Instance of UserPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserPatch other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
