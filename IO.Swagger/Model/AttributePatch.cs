...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class AttributePatch :  IEquatable<AttributePatch>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AttributePatch" /> class.
        /// </summary>
        ...
        public AttributePatch(List<string> ListIds = null, string Name = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AttributePatch {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as AttributePatch);
        }

        /// <summary>
        /// Returns true if AttributePatch instances are equal
        /// </summary>
        /// <param name="other">Instance of AttributePatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AttributePatch other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
