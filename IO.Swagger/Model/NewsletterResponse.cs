...
{
    /// <summary>
    /// The response for getting newsletters
    /// </summary>
    [DataContract]
    public partial class NewsletterResponse :  IEquatable<NewsletterResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="NewsletterResponse" /> class.
        /// </summary>
        /// <param name="Info">Info.</param>
        /// <param name="Value">Value.</param>
        public NewsletterResponse(Info Info = null, List<NewsletterGet> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<NewsletterGet> Value { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as NewsletterResponse);
        }

        /// <summary>
        /// Returns true if NewsletterResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of NewsletterResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(NewsletterResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
