...
{
    /// <summary>
    /// The response for getting the recipients
    /// </summary>
    [DataContract]
    public partial class RecipientResponse :  IEquatable<RecipientResponse>
    {
        /// <summary>
        ...
        public RecipientResponse(Info Info = null, List<RecipientGet> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<RecipientGet> Value { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientResponse);
        }

        /// <summary>
        /// Returns true if RecipientResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
