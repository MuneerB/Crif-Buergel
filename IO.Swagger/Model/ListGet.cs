...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListGet :  IEquatable<ListGet>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListGet" /> class.
        /// </summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListGet);
        }

        /// <summary>
        /// Returns true if ListGet instances are equal
        /// </summary>
        /// <param name="other">Instance of ListGet to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListGet other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
