...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class PatchResponse :  IEquatable<PatchResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PatchResponse" /> class.
        /// </summary>
        /// <param name="Info">Info.</param>
        public PatchResponse(Info Info = null)
        {
            this.Info = Info;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as PatchResponse);
        }

        /// <summary>
        /// Returns true if PatchResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of PatchResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PatchResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
