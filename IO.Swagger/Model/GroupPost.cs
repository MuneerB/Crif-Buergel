...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupPost :  IEquatable<GroupPost>
    {
        /// <summary>
        ...
        public GroupPost(string Name = null, string Description = null, string ListId = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupPost);
        }

        /// <summary>
        /// Returns true if GroupPost instances are equal
        /// </summary>
        /// <param name="other">Instance of GroupPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupPost other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
