...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipientSimple :  IEquatable<RecipientSimple>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSimple" /> class.
        /// </summary>
        /// <param name="Email">Email.</param>
        /// <param name="FirstName">FirstName.</param>
        /// <param name="LastName">LastName.</param>
        public RecipientSimple(string Email = null, string FirstName = null, string LastName = null)
        {
            this.Email = Email;
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSimple {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSimple);
        }

        /// <summary>
        /// Returns true if RecipientSimple instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSimple to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSimple other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
