...
{
    /// <summary>
    /// RecipientSubscribeResponse
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribeResponse :  IEquatable<RecipientSubscribeResponse>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribeResponse" /> class.
        /// </summary>
        /// <param name="Info">Info.</param>
        /// <param name="Value">Value.</param>
        public RecipientSubscribeResponse(Info Info = null, List<RecipientSubscribeResponseValue> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<RecipientSubscribeResponseValue> Value { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribeResponse {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribeResponse);
        }

        /// <summary>
        /// Returns true if RecipientSubscribeResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribeResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribeResponse other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
