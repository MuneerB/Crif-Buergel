...
{
    /// <summary>
    /// RecipientSubscribeResponseValueResultSuccess
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribeResponseValueResultSuccess :  IEquatable<RecipientSubscribeResponseValueResultSuccess>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribeResponseValueResultSuccess" /> class.
        /// </summary>
        /// <param name="Inserted">Inserted.</param>
        public RecipientSubscribeResponseValueResultSuccess(int? Inserted = null)
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribeResponseValueResultSuccess {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribeResponseValueResultSuccess);
        }

        /// <summary>
        /// Returns true if RecipientSubscribeResponseValueResultSuccess instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribeResponseValueResultSuccess to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribeResponseValueResultSuccess other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
            ...
            return 
                (
                    ...
                    this.Inserted != null &&
                    this.Inserted.Equals(other.Inserted)
                );
        }
        ...
        public override int GetHashCode()
        {
            ...
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Inserted != null)
                    hash = hash * 59 + this.Inserted.GetHashCode();
                return hash;
            }
        }
    }
