...
{
    /// <summary>
    /// The response for getting reports
    /// </summary>
    [DataContract]
    public partial class ReportResponse :  IEquatable<ReportResponse>
    {
        ...
        public ReportResponse(Info Info = null, List<Report> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ReportResponse);
        }

        /// <summary>
        /// Returns true if ReportResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ReportResponse to be compared</param>
        /// <returns>Boolean</returns>
