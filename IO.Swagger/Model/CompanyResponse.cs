...
{
    /// <summary>
    /// The response for getting the company
    /// </summary>
    [DataContract]
    public partial class CompanyResponse :  IEquatable<CompanyResponse>
    {
        ...
        public CompanyResponse(Info Info = null, List<CompanyGet> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<CompanyGet> Value { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as CompanyResponse);
        }

        /// <summary>
        /// Returns true if CompanyResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of CompanyResponse to be compared</param>
        /// <returns>Boolean</returns>
