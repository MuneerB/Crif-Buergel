...
{
    /// <summary>
    /// The response when a resource was successfully created
    /// </summary>
    [DataContract]
    public partial class ApiResponsePost :  IEquatable<ApiResponsePost>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ApiResponsePost" /> class.
        /// </summary>
        /// <param name="Info">Info.</param>
        /// <param name="Value">Value.</param>
        public ApiResponsePost(Info Info = null, List<ModelWithId> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<ModelWithId> Value { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ApiResponsePost {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ApiResponsePost);
        }

        /// <summary>
        /// Returns true if ApiResponsePost instances are equal
        /// </summary>
        /// <param name="other">Instance of ApiResponsePost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ApiResponsePost other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
