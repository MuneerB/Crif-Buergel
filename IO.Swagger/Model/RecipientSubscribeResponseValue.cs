...
{
    /// <summary>
    /// RecipientSubscribeResponseValue
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribeResponseValue :  IEquatable<RecipientSubscribeResponseValue>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribeResponseValue" /> class.
        /// </summary>
        /// <param name="Result">Result.</param>
        public RecipientSubscribeResponseValue(RecipientSubscribeResponseValueResult Result = null)
        {
            this.Result = Result;
        }
        ...
        public RecipientSubscribeResponseValueResult Result { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribeResponseValue {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribeResponseValue);
        }

        /// <summary>
        /// Returns true if RecipientSubscribeResponseValue instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribeResponseValue to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribeResponseValue other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
