...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class GroupPatch :  IEquatable<GroupPatch>
    {
        /// <summary>
        ...
        public GroupPatch(string Name = null, string Description = null)
        {
            this.Name = Name;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as GroupPatch);
        }

        /// <summary>
        /// Returns true if GroupPatch instances are equal
        /// </summary>
        /// <param name="other">Instance of GroupPatch to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(GroupPatch other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
