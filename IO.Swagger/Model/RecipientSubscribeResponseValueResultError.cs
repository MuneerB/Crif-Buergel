...
{
    /// <summary>
    /// RecipientSubscribeResponseValueResultError
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribeResponseValueResultError :  IEquatable<RecipientSubscribeResponseValueResultError>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribeResponseValueResultError" /> class.
        /// </summary>
        /// <param name="Failed">Failed.</param>
        /// <param name="Recipients">Recipients.</param>
        public RecipientSubscribeResponseValueResultError(int? Failed = null, RecipientSubscribeResponseValueResultErrorRecipients Recipients = null)
        {
            this.Failed = Failed;
        ...
        public RecipientSubscribeResponseValueResultErrorRecipients Recipients { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribeResponseValueResultError {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribeResponseValueResultError);
        }

        /// <summary>
        /// Returns true if RecipientSubscribeResponseValueResultError instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribeResponseValueResultError to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribeResponseValueResultError other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
