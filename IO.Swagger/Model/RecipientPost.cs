...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipientPost :  IEquatable<RecipientPost>
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientPost" /> class.
        /// </summary>
        /// <param name="ListId">the id of the list where the recipient should be added to. If no list_id is given, the default_list of the account is used.</param>
        ...
        public RecipientPost(string ListId = null, string Email = null, string Phone = null, GenderEnum? Gender = null, string FirstName = null, string LastName = null, bool? IsUnsubscribed = null, bool? IsBlacklisted = null, string CustomAttribute_ = null)
        {
            this.ListId = ListId;
            this.Email = Email;
            this.Phone = Phone;
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientPost);
        }

        /// <summary>
        /// Returns true if RecipientPost instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientPost to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientPost other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
