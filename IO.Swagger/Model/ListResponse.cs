...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ListResponse :  IEquatable<ListResponse>
    {
        /// <summary>
        ...
        public ListResponse(Info Info = null, List<ListGet> Value = null)
        {
            this.Info = Info;
            this.Value = Value;
        }
        ...
        public List<ListGet> Value { get; set; }
        /// <summary>
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as ListResponse);
        }

        /// <summary>
        /// Returns true if ListResponse instances are equal
        /// </summary>
        /// <param name="other">Instance of ListResponse to be compared</param>
        /// <returns>Boolean</returns>
