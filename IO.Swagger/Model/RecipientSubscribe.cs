...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class RecipientSubscribe :  IEquatable<RecipientSubscribe>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecipientSubscribe" /> class.
        /// </summary>
        /// <param name="Recipient">Recipient.</param>
        public RecipientSubscribe(RecipientSubscribeRecipient Recipient = null)
        {
        ...
        public RecipientSubscribeRecipient Recipient { get; set; }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecipientSubscribe {\n");
        ...
        public override bool Equals(object obj)
        {
            ...
            return this.Equals(obj as RecipientSubscribe);
        }

        /// <summary>
        /// Returns true if RecipientSubscribe instances are equal
        /// </summary>
        /// <param name="other">Instance of RecipientSubscribe to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecipientSubscribe other)
        {
            // credit: http://stackoverflow.com/a/10454552/677735
            if (other == null)
                return false;
